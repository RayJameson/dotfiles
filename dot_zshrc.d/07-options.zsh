...
zstyle ':fzf-tab:*' fzf-flags --bind=ctrl-u:preview-up,ctrl-d:preview-down --bind=ctrl-j:down,ctrl-k:up --no-multi --prompt="$FZF_PROMPT_SYMBOL " --marker="$FZF_MARKER" --pointer="$FZF_POINTER" --reverse --color=dark \
...
setopt NO_HIST_VERIFY            # Execute immediately upon history expansion.
